...
//  arrays indexed using SDL_SCANCODE_* codes, e.g. ImGui::IsKeyPressed(SDL_SCANCODE_SPACE).
// Missing features:
...
//  SDL_DISABLE_WINDOWS_IME. [ ] Platform: Gamepad support (need to use SDL_GameController API to
//  fill the io.NavInputs[] value when ImGuiConfigFlags_NavEnableGamepad is set).
